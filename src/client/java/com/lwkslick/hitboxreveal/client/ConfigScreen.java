        ...
        return YetAnotherConfigLib.createBuilder()
                ...
                .category(ConfigCategory.createBuilder()
                        ...
                        .group(OptionGroup.createBuilder()
                                ...
                                .option(Option.<Boolean>createBuilder()
                                        .name(Text.literal("Enable close range color"))
                                        .description(OptionDescription.of(Text.literal("When off, close range uses the default color instead.")))
                                        .binding(true, () -> ModConfig.closeColorEnabled, v -> ModConfig.closeColorEnabled = v)
                                        .controller(TickBoxControllerBuilder::create)
                                        .build())
                                .option(Option.<Boolean>createBuilder()
                                        .name(Text.literal("Enable crit color"))
                                        .description(OptionDescription.of(Text.literal("When off, crit-ready targets use the default color instead.")))
                                        .binding(true, () -> ModConfig.critColorEnabled, v -> ModConfig.critColorEnabled = v)
                                        .controller(TickBoxControllerBuilder::create)
                                        .build())
                                .option(Option.<Float>createBuilder()
